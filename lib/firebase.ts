...
if (!firebaseConfig.apiKey) {
  console.warn("⚠️ Firebase API Key no detectada. Por favor, configura las variables de entorno en el menú Settings (VITE_FIREBASE_API_KEY, etc.) para que el inicio de sesión funcione.");
}
...
try {
  if (firebaseConfig.apiKey) {
    ...
    app = initializeApp({ apiKey: "placeholder-to-avoid-crash", projectId: "placeholder" });
  }
} catch (e) {
